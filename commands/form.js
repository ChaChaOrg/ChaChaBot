...
const addMessage = "The \"add\" subcommand adds a form to the list of available forms for a Pokemon species. Write" +
    ...
    "\n\n Empty template: +form" +
    " add <speciesName> <formName> <ability1> <ability2> <ability3> <hpBaseStat> <attackBaseStat>" +
    " <defenseBaseStat> <specialAttackBaseStat> <specialDefenseBaseStat> <speedBaseStat> <firstType> <secondType>" +
